...
#     out_np = out.detach().cpu().numpy()
    ...
    np.save(f'saved_arrays/overall_cm_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', overall_cm, allow_pickle=True)
    np.save(f'saved_arrays/group_0_cm_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', group_0_cm, allow_pickle=True)
    np.save(f'saved_arrays/group_1_cm_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', group_1_cm, allow_pickle=True)    
    ...
    np.save(f'saved_arrays/auc_ovr_diff_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', macro_roc_auc_ovr_diff, allow_pickle=True)
    np.save(f'saved_arrays/auc_ovr_overall_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', macro_roc_auc_ovr, allow_pickle=True)
    ...
    np.save(f'saved_arrays/acc_student_{args.dataset}_{args.seed}_c={class_weights}_{p_or_q}.npy', float(score_str), allow_pickle=True)
